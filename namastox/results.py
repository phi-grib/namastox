...
def action_results(raname, username, step=None, out='text'):
    ...
    if out=='json':
        ...
        for iresult in results:
            ...
            if 'label' in iresult:
                ilabel = iresult['label']
            else:
                ilabel = 'na'
                              
            if 'decision' in iresult:
                odict.append({'id':iresult['id'],'name':iresult['name'], 'label': ilabel,
...
def action_result(raname, username, resultid, out='text'):
...
def action_task(raname, username, resultid):
...
def action_pendingTasks(raname, username):
...
def action_pendingTask(raname, username, resultid):
...
def action_upstreamTasks(raname, username, resultid):
