...
def action_update(raname, username, ifile, ofile=None):
...
def action_update_general_info (raname, username, input_dict):
...
def action_update_result (raname, username, step, input_dict):
